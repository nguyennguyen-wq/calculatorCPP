    ...
    , factorresult(0.0), waitingForOperand(true)
{
    ...
    pointButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *changeSignButton = createButton(tr("\u2212"), &Calculator::changeSignClicked);
    changeSignButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *backspaceButton = createButton(tr("Backspace"), &Calculator::backspaceClicked);
    backspaceButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *clearAllButton = createButton(tr("Clear All"), &Calculator::clearAll);
    clearAllButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *divisionButton = createButton(tr("\303\267"), &Calculator::productOperatorClicked);
    divisionButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *timesButton = createButton(tr("\303\227"), &Calculator::productOperatorClicked);
    timesButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *minusButton = createButton(tr("-"), &Calculator::SumOperatorClicked);
    minusButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *plusButton = createButton(tr("+"), &Calculator::SumOperatorClicked);
    plusButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *squareRootButton = createButton(tr("Sqrt"), &Calculator::unaryOperatorClicked);
    squareRootButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *powerButton = createButton(tr("x\302\262"), &Calculator::unaryOperatorClicked);
    powerButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *reciprocalButton = createButton(tr("1/x"), &Calculator::unaryOperatorClicked);
    reciprocalButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    Button *equalButton = createButton(tr("="), &Calculator::equalClicked);
    equalButton->setStyleSheet("font: bold;background-color: yellow;font-size: 36px;height: 48px;width: 120px;");
    ...
    setWindowTitle(tr("Demo Calculator"));
}
...
void Calculator::changeSignClicked()
{
    ...
    newItem->setSizeHint(QSize(20, 30)); 
    newItem->setFont(itemFont); 
    listWidget->insertItem(listWidget->count() - 1, newItem);
}
